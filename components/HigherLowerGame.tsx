            ...
            case 'gameover':
                return (
                    <div className="text-center bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl p-8 max-w-lg mx-auto fade-in">
                        ...
                        <h1 className="text-4xl sm:text-5xl font-bold mb-4 text-white" style={{textShadow: '0 0 15px rgba(255,255,255,0.1)'}}>{gameDetails.title}</h1>
                ...
                return (
                    <div className="w-full flex flex-col items-center gap-6 fade-in">
                        <div className="flex items-center gap-6">
                            <button onClick={onExit} className="px-4 py-2 text-sm bg-white/5 hover:bg-white/10 rounded-full transition-colors">&larr; Exit</button>
                            <div className="text-center bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-2">
                                <p className="text-2xl font-bold">Streak: <span className="text-yellow-400">{streak}</span></p>
                            </div>
                        </div>
