    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        {list.slice(0, 8).map(provider => (
          <div key={provider.provider_name} title={provider.provider_name} className="flex items-center gap-2 bg-white/10 p-1 pr-1 rounded-full">
            <img 
...
export const Providers: React.FC<ProvidersProps> = ({ providers }) => {
  return (
    <div className="flex flex-col gap-4 p-4 rounded-lg bg-black/30">
