...
export const WatchlistPage: React.FC<WatchlistPageProps> = ({ onSelectMedia }) => {
  ...
  if (likes.length === 0) {
    return (
      <div className="text-center text-white/80 fade-in">
        <h2 className="text-xl font-bold mb-4 text-white" style={{textShadow: '0 2px 4px rgba(0,0,0,0.2)'}}>Your Watchlist</h2>
  ...
  return (
    <div className="w-full max-w-7xl fade-in">
      <h2 className="text-2xl font-bold mb-6 text-white" style={{textShadow: '0 2px 4px rgba(0,0,0,0.2)'}}>My Watchlist</h2>
